    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_testing.apirequest', verbose_name='API请求')),
                ('test_suite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_testing.testsuite', verbose_name='测试套件')),
            ],
            options={
                'verbose_name': '套件请求',
