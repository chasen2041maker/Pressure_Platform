    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('@/views/performance-testing/EnvironmentManagement.vue')
            },
            {
                path: 'account-pools',
                name: 'PerfAccountPools',
                component: () => import('@/views/performance-testing/AccountPoolManagement.vue')
            },
            {
                path: 'scenarios/:id',
