export default {
  testcase: {
    ...
    selectImportProject: 'Select import project',
    selectImportFile: 'Please select an import file',
    selectedFile: 'Selected File',
    importRecordTitle: 'Test Case Import Records',
    ...
    noFailureDetails: 'No failure details',
    failureReason: 'Failure Reason',
    downloadFailureReport: 'Download Failure Report',
    ...
    downloadTemplateSuccess: 'Import template downloaded successfully',
    downloadTemplateFailed: 'Failed to download import template',
    importCreated: 'Import task created. Please check the import records for progress',
    importCreateFailed: 'Failed to create import task',
    fetchImportRecordsFailed: 'Failed to fetch import records',
    fetchImportDetailFailed: 'Failed to fetch import record detail',
    invalidImportFile: 'Only .xlsx files are supported',
    importProjectRequired: 'Please select an import project',
